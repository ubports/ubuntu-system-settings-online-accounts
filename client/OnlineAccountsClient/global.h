...
#ifndef ONLINE_ACCOUNTS_CLIENT_GLOBAL_H
#define ONLINE_ACCOUNTS_CLIENT_GLOBAL_H

#include <QtCore/QtGlobal>

#if defined(BUILDING_ONLINE_ACCOUNTS_CLIENT)
#  define OAC_EXPORT Q_DECL_EXPORT
#else
#  define OAOAC_EXPORT Q_DECL_IMPORT
#endif

#endif // ONLINE_ACCOUNTS_CLIENT_GLOBAL_H
