...
void OnlineAccountsHooksTest::testValidHooks_data()
{
    ...
    files["providers/com.ubuntu.test_MyApp.provider"] =
        ...
        "<!--this file is auto-generated by online-accounts-hooks2; do not modify-->\n"
        "<provider id=\"com.ubuntu.test_MyApp\">\n"
        "  <name>Google</name>\n"
        "  <icon>%1/google.svg</icon>\n"
        "  <profile>com.ubuntu.test_MyApp_0.2</profile>\n"
        "  <package-dir>/tmp/hooks-test2/package</package-dir>\n"
        "</provider>\n").arg(m_packageDir.path());
    files["qml-plugins/com.ubuntu.test_MyApp/Main.qml"] =
        "Something here";
    ...
    files.clear();
    files["applications/com.ubuntu.test_MyScope.application"] =
        "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
        "<!--this file is auto-generated by online-accounts-hooks2; do not modify-->\n"
        "<application id=\"com.ubuntu.test_MyScope\">\n"
        "  <profile>com.ubuntu.test_MyScope_0.3</profile>\n"
        "  <package-dir>/tmp/hooks-test2/package</package-dir>\n"
        "  <desktop-entry>com.ubuntu.test_MyScope</desktop-entry>\n"
        "  <services>\n"
        "    <service id=\"com.ubuntu.test_MyScope_google\">\n"
        "      <description>.</description>\n"
        "    </service>\n"
        "  </services>\n"
        "</application>\n";
    files["services/com.ubuntu.test_MyScope_google.service"] =
        "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
        "<!--this file is auto-generated by online-accounts-hooks2; do not modify-->\n"
        "<service id=\"com.ubuntu.test_MyScope_google\">\n"
        "  <type>com.ubuntu.test_MyScope</type>\n"
        "  <provider>google</provider>\n"
        "  <name>.</name>\n"
        "  <profile>com.ubuntu.test_MyScope_0.3</profile>\n"
        "</service>\n";
    QTest::newRow("minimal") <<
        "com.ubuntu.test_MyScope_0.3.accounts" <<
        "{"
        "  \"scope\": true,"
        "  \"services\": ["
        "    {"
